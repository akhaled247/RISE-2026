...
def _apply_specrl_ma_recipe_b(
    ...
    *,
    ...
    from rise_training.safepo.env_hook import is_specrlbench_env
...
def train_with_safepo_ma(
    ...
    **_extra: Any,
    ...
    from rise_training.safepo.env_hook import patch_safepo_ma_env_factory
    from rise_training.paths import ensure_specrlbench_paths
    from rise_training.safepo.registry import MA_ALGO_MODULE, resolve_ma_algo
    from rise_training.safepo.runners import _patch_epoch_logger_tensorboard

    # PYTHONPATH for spawn workers, spawn before CUDA, farama filter.
    ensure_specrlbench_paths()
    _ensure_mp_spawn_before_cuda()
    from rise_training.safepo.ma_safepo_patches import apply_ma_safepo_patches
