...
def __register_helper(env_id, entry_point, spec_kwargs=None, **kwargs):
    ...
    # print(f"__register_helper, spec_kwargs = {spec_kwargs}, kwargs = {kwargs}")
    register(
        id=env_id,
...
# ----------------------------------------
ltl_tasks = {'LTL0': {}, 
             'LTL0.partial': {'partial_observability': 'True'}, 
             'LTL0.overlap': {'allow_overlap': 'True'},
             'LTL0.partial_overlap': {'partial_observability': 'True', 'allow_overlap': 'True'},

             'LTL1': {}, 
             'LTL1.partial': {'partial_observability': 'True'},
             'LTL1.overlap': {'allow_overlap': 'True'},
             'LTL1.partial_overlap': {'partial_observability': 'True', 'allow_overlap': 'True'},

             'LTL2': {}, 
             'LTL2.partial': {'partial_observability': 'True'},
             'LTL2.overlap': {'allow_overlap': 'True'},
